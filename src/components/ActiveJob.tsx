    ...
    <div className="pt-28 text-black">
      ...
      <div className="grid grid-cols-1 grid-rows-1 gap-4">
        <div className="w-full group">
          <div className="cursor-pointer border-2 border-spacing-4 border-black overflow-hidden relative h-48 rounded-xl shadow-xl mx-auto bg-white bg-cover flex flex-col justify-between p-6">
            ...
            <div className="flex flex-row items-center space-x-4 z-10">
              <div className="text-content w-full">
                ...
                <div className="text-sm text-stone-800 flex justify-between">
                  <p>Skills required: ...</p>
                  <p className="ml-auto text-right">Employer name</p>{" "}
                  {/* Added ml-auto */}
                </div>
              </div>
            </div>
